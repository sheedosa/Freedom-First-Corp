...
export const content = {
  ...
  insightsPage: {
    ...
    articles: [
      ...
      { id: 4, title: "Upstream Profiles Freedom First's Approach to Energy Development", category: 'Company Updates' },
      { id: 3, title: 'Bringing Lessons from the Permian Basin to Libya', category: 'Field Execution' },
