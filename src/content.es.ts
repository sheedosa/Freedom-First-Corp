...
export const contentEs: Content = {
  ...
  insightsPage: {
    ...
    articles: [
      ...
      { id: 4, title: "Upstream Profiles Freedom First's Approach to Energy Development", category: 'Novedades de la Empresa' },
      { id: 3, title: 'Bringing Lessons from the Permian Basin to Libya', category: 'Ejecución en Campo' },
  ...
  insightUpstream: {
    backToInsights: 'Volver a Perspectivas',
    allInsights: 'Todas las Perspectivas',
    category: 'Novedades de la Empresa',
